...
app.get('/tee-text', function(req, res) {
	...
	function sendQuote() {
		...
		else
		{
			...
			var url = 'https://www.shirts.io/api/v1/quote/?api_key=' + apiKey + '&garment[0][product_id]=1&garment[0][color]=' + req.session.color + '&garment[0][sizes][' + req.session.size + ']=10&print[front][color_count]=1';
